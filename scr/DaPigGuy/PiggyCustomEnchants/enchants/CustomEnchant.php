...
class CustomEnchant extends Enchantment
{
	...
	public const RARITY_SIMPLE = 888;
	public const RARITY_UNIQUE = 887;
	public const RARITY_ELITE = 886;
	public const RARITY_ULTIMATE = 885;
	public const RARITY_LEGENDARY = 884;
	public const RARITY_SOUL = 883;
	public const RARITY_HEROIC = 882;
	public const RARITY_MASTERY = 881;
    ...
    {
        $this->plugin = $plugin;
        $this->rarity = (int)array_flip(Utils::RARITY_NAMES)[ucfirst(strtolower($plugin->getEnchantmentData($this->name, "rarities", "simple", Utils::RARITY_NAMES[$this->rarity])))];
