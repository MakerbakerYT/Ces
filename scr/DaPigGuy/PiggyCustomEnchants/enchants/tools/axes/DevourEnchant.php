...
class DevourEnchant extends ReactiveEnchantment
{
    /** @var string */
    public $name = "Devour";
    /** @var int */
    ...
    {
        return ["interval" => 20, "durationMultiplier" => 20, "base" => 1, "multiplier" => 0.88];
    }
    ...
    public function react(Player $player, Item $item, Inventory $inventory, int $slot, Event $event, int $level, int $stack): void
    {
        if ($event instanceof EntityDamageByEntityEvent) {
			...
			if($entity instanceof Living) {
				...
				$player->sendMessage("§b*§d*§b* §6Devouring The Enemy! §8(§7Constant Double Bleed Damage§8) §b*§d*§b*");
