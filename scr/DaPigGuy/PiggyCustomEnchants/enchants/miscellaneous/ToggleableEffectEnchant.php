...
class ToggleableEffectEnchant extends ToggleableEnchantment
{
    ...
    public function __construct(PiggyCustomEnchants $plugin, int $id, string $name, int $maxLevel, int $usageType, int $itemType, int $effect, int $baseAmplifier = 0, int $amplifierMultiplier = 1, int $rarity = self::RARITY_SIMPLE)
    {
        $this->name = $name;
        $this->rarity = $rarity;
